...
export const STANCE_OPTIONS: Record<string, {
  ...
  health: {
    label: "Health", icon: "💪",
    stances: [
      { id: "carnivore", label: "Carnivore", color: "#ef4444" },
      { id: "vegan", label: "Vegan", color: "#10b981" },
      { id: "keto", label: "Keto", color: "#f59e0b" },
      { id: "plantBased", label: "Plant-Based", color: "#22c55e" },
      { id: "naturalHealth", label: "Natural Health", color: "#84cc16" },
      { id: "modernMedicine", label: "Modern Medicine", color: "#3b82f6" },
      { id: "biohacker", label: "Biohacker", color: "#8b5cf6" },
      { id: "bodybuilder", label: "Bodybuilder", color: "#dc2626" },
      { id: "crossfit", label: "CrossFit", color: "#f97316" },
    ...
    opposites: {
      ...
      vegan: ["carnivore", "keto"],
      keto: ["vegan", "plantBased"],
      plantBased: ["carnivore", "keto"],
      naturalHealth: ["modernMedicine", "proVax"],
      modernMedicine: ["naturalHealth", "antiVax"],
      biohacker: ["naturalHealth"],
      bodybuilder: ["calisthenics", "crossfit"],
      crossfit: ["bodybuilder", "calisthenics"],
  ...
  education: {
    ...
    stances: [
      { id: "collegeIsWorthIt", label: "College Is Worth It", color: "#3b82f6" },
      { id: "collegeIsAScam", label: "College Is a Scam", color: "#ef4444" },
      { id: "tradeSchool", label: "Trade School", color: "#f59e0b" },
      { id: "selfTaught", label: "Self-Taught", color: "#10b981" },
      { id: "homeschool", label: "Homeschool", color: "#8b5cf6" },
      { id: "publicSchool", label: "Public School", color: "#2563eb" },
      { id: "privateSchool", label: "Private School", color: "#d97706" },
      { id: "unschooling", label: "Unschooling", color: "#ec4899" },
    ],
    opposites: {
      collegeIsWorthIt: ["collegeIsAScam", "tradeSchool", "selfTaught"],
      collegeIsAScam: ["collegeIsWorthIt"],
      tradeSchool: ["collegeIsWorthIt"],
      selfTaught: ["collegeIsWorthIt", "publicSchool"],
      homeschool: ["publicSchool", "unschooling"],
      publicSchool: ["privateSchool", "homeschool", "unschooling"],
      privateSchool: ["publicSchool", "homeschool"],
      unschooling: ["publicSchool", "privateSchool", "homeschool"],
    },
  },
  dating: {
    label: "Dating", icon: "💕",
    stances: [
      ...
      { id: "mgtow", label: "MGTOW", color: "#6b7280" },
      { id: "feminist", label: "Feminist", color: "#ec4899" },
      { id: "highValue", label: "High Value", color: "#d97706" },
      { id: "casualDating", label: "Casual Dating", color: "#f97316" },
      { id: "waitingForMarriage", label: "Waiting for Marriage", color: "#7c3aed" },
      { id: "datingApps", label: "Dating Apps", color: "#3b82f6" },
      { id: "organicOnly", label: "Organic Only", color: "#10b981" },
      { id: "polyamorous", label: "Polyamorous", color: "#f43f5e" },
      { id: "monogamous", label: "Monogamous", color: "#2563eb" },
    ],
    opposites: {
      traditional: ["modern", "feminist", "casualDating", "polyamorous"],
      modern: ["traditional", "mgtow", "waitingForMarriage"],
      mgtow: ["feminist", "modern", "datingApps"],
      feminist: ["mgtow", "traditional", "highValue"],
      highValue: ["casualDating", "feminist"],
      casualDating: ["waitingForMarriage", "traditional", "highValue"],
      waitingForMarriage: ["casualDating", "modern", "polyamorous"],
      datingApps: ["organicOnly", "mgtow"],
      organicOnly: ["datingApps"],
      polyamorous: ["monogamous", "traditional", "waitingForMarriage"],
      monogamous: ["polyamorous", "casualDating"],
    },
  },
  conspiracy: {
...
export const DEBATE_TOPICS: Record<string, { general: string[]; stancePairs: Record<string, string[]> }> = {
  ...
  health: {
    general: ["Is the fitness industry a scam?", "Should everyone take supplements?", "Is obesity a personal choice or a systemic issue?", "Are seed oils actually bad for you?", "Is mental health overdiagnosed?"],
    stancePairs: {
      "carnivore|vegan": ["Is meat essential for human health?", "Can you build muscle on a vegan diet?", "Is the carnivore diet a fad or backed by science?", "Are humans designed to eat meat?", "Which diet is better for the planet?", "Is veganism an eating disorder in disguise?"],
      "keto|plantBased": ["Are carbs the enemy?", "Is keto sustainable long-term?", "Does a plant-based diet reverse disease?", "Which diet has better long-term outcomes?"],
      "naturalHealth|modernMedicine": ["Is Big Pharma more interested in profit than cures?", "Should you trust your doctor or do your own research?", "Are natural remedies legitimate medicine?", "Is the healthcare system designed to keep you sick?"],
  ...
  education: {
    general: ["Is the education system broken?", "Should school start later?", "Is homework beneficial or pointless?", "Should financial literacy be mandatory in schools?", "Are standardized tests a fair measure of intelligence?"],
    stancePairs: {
      "collegeIsWorthIt|collegeIsAScam": ["Is a degree still worth the debt?", "Do employers actually care about your degree?", "Is college just expensive daycare for adults?", "Does college teach critical thinking or just compliance?", "Are dropouts more successful than graduates?", "Is the college experience worth $200K?"],
      "tradeSchool|collegeIsWorthIt": ["Should more people skip college for trades?", "Do plumbers make more than most graduates?", "Is there a skills gap because everyone went to college?", "Are trade skills more recession-proof than degrees?"],
      "selfTaught|collegeIsWorthIt": ["Can YouTube replace a professor?", "Is self-education the future?", "Do bootcamps produce better developers than CS degrees?", "Is motivation more important than a degree?"],
      "homeschool|publicSchool": ["Are homeschooled kids better educated?", "Does public school socialize kids or just institutionalize them?", "Should parents be allowed to homeschool without oversight?", "Is public school one-size-fits-none?"],
      "privateSchool|publicSchool": ["Is private school worth the tuition?", "Does private school create better outcomes or just privilege?", "Should public funding go to private schools via vouchers?"],
      "unschooling|publicSchool": ["Is unschooling neglect or genius?", "Do kids learn better when they choose what to study?", "Is the traditional classroom model outdated?"],
    },
  },
  dating: {
    general: ["Is dating harder now than ever before?", "Are dating apps ruining romance?", "Should the man always pay on the first date?", "Is the friend zone real?", "Has social media killed real connection?"],
    stancePairs: {
      "traditional|modern": ["Should men lead in relationships?", "Is chivalry dead or outdated?", "Are traditional gender roles in dating healthier?", "Has modern dating made people disposable?", "Is the sexual revolution a net positive?", "Should you live together before marriage?"],
      "traditional|feminist": ["Are gender roles oppressive or natural?", "Has feminism improved or ruined dating?", "Should women pursue men or wait to be pursued?", "Is the patriarchy real or a myth?"],
      "mgtow|feminist": ["Is marriage a bad deal for men?", "Are men opting out of dating or just bitter?", "Has the dating market become unfair for average men?", "Is toxic masculinity real or a shaming tactic?"],
      "highValue|casualDating": ["Should you have standards or just have fun?", "Is the 'high value' movement just materialism?", "Does casual dating prevent real connection?", "Is settling worse than being alone?"],
      "casualDating|waitingForMarriage": ["Is waiting until marriage realistic in 2026?", "Does casual dating cheapen intimacy?", "Is purity culture harmful or protective?", "Can you have a healthy relationship without physical intimacy first?"],
      "datingApps|organicOnly": ["Have dating apps made us lazy?", "Is meeting someone in person a lost art?", "Do dating apps create paradox of choice?", "Is swiping dehumanizing?"],
      "polyamorous|monogamous": ["Is monogamy natural or a social construct?", "Can you truly love more than one person?", "Is polyamory just an excuse to cheat with permission?", "Is jealousy a sign of love or insecurity?"],
    },
  },
  conspiracy: {
...
export const FACTION_MOTTOS: Record<string, string> = {
  ...
  // Dating
  traditional: "Old school romance", modern: "Love on my terms", mgtow: "Walking my own path", feminist: "Equal partners only",
  highValue: "Standards over settling", casualDating: "No labels needed", waitingForMarriage: "Worth the wait", datingApps: "Swipe right on love",
  organicOnly: "Let it happen naturally", polyamorous: "Love is not a pie", monogamous: "One and only",
  // Religion
...
export const FAKE_USERS = [
  ...
  { name: "LogicLord", elo: 1723, wins: 98, losses: 45, followers: 8700, color: "#8B4513", categories: ["philosophy", "economics"], stances: { philosophy: "rationalist", economics: "austrian", religion: "atheism", finance: "valueInvestor" } },
  ...
  { name: "PolicyWonk", elo: 1612, wins: 76, losses: 48, followers: 4800, color: "#64b5f6", categories: ["politics", "economics"], stances: { politics: "democrat", economics: "keynesian", religion: "agnosticism", finance: "tradFi" } },
  { name: "SkepticalMind", elo: 1589, wins: 134, losses: 89, followers: 9100, color: "#8B4513", categories: ["philosophy", "conspiracy"], stances: { philosophy: "empiricist", conspiracy: "skeptic", religion: "buddhism", finance: "bear" } },
  { name: "RationalRex", elo: 1567, wins: 67, losses: 39, followers: 3200, color: "#ffd43b", categories: ["finance", "economics"], stances: { finance: "bull", economics: "capitalist", philosophy: "rationalist" } },
  ...
  { name: "MarketBull", elo: 1534, wins: 55, losses: 33, followers: 11200, color: "#ff7043", categories: ["economics", "finance"], stances: { economics: "capitalist", finance: "bull", sports: "statsFirst" } },
  ...
  { name: "RizzDebater", elo: 1388, wins: 33, losses: 25, followers: 22100, color: "#42a5f5", categories: ["culture", "sports"], stances: { culture: "modernist", sports: "newEra", finance: "degen", pill: "pinkPill" } },
  { name: "TouchGrass420", elo: 1367, wins: 29, losses: 24, followers: 3100, color: "#7e57c2", categories: ["conspiracy", "economics"], stances: { conspiracy: "debunker", economics: "socialist", finance: "bear", pill: "greenPill" } },
];
